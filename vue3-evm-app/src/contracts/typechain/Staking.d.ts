...
interface StakingInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getUserStakes', values: [string]): string
  encodeFunctionData(functionFragment: 'reward', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'stake', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'stakes', values: [BigNumberish]): string
...
export class Staking extends BaseContract {
  ...
  populateTransaction: {
    getUserStakes(user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    stakes(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
